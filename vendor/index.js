...
switch (curso) {
    case 'backend':
        data = cursosData.cursoBackend;
        break;
    case 'procrastinacion':
        data = cursosData.cursoProcrastinacion;
        break;
    default:
...
async function cargarHref() {
    const nuevoEnlace = `checkout.html?curso=${curso}`;

document.getElementById("checkout-button1").setAttribute("href", nuevoEnlace);
document.getElementById("checkout-button2").setAttribute("href", nuevoEnlace);
document.getElementById("checkout-button3").setAttribute("href", nuevoEnlace);
document.getElementById("checkout-button4").setAttribute("href", nuevoEnlace);
document.getElementById("checkout-button5").setAttribute("href", nuevoEnlace);
document.getElementById("checkout-button6").setAttribute("href", nuevoEnlace);
